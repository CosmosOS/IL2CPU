  ...
  public class Mul_Ovf : ILOp
  {
    ...
    public static void DoExecute(uint xStackContentSize, string aBaseLabel)
    {
      ...
      if (xStackContentSize > 4)
      {
        ...
        XS.Or(XSRegisters.RAX, XSRegisters.RSP, sourceDisplacement: 12);
        ...
        XS.Multiply(XSRegisters.RSP, displacement: 8);
        ...
        XS.Multiply(XSRegisters.RSP, displacement: 12);
        // add result of LEFT_LOW * RIGHT_HIGH + RIGHT_LOW + LEFT_HIGH
        XS.Add(XSRegisters.RCX, XSRegisters.RAX);
        ...
        XS.Add(XSRegisters.RDX, XSRegisters.RCX);
