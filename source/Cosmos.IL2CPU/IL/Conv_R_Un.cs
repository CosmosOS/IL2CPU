            ...
            if (!xValueIsFloat)
            {
                switch (xValueSize)
                {
                    ...
                    case 4:
                        ...
                        XS.Set(RBP, RAX, destinationDisplacement: -0xE0, destinationIsIndirect: true);
                        XS.SSE2.ConvertSI2SD(XMM0, RBP, sourceDisplacement: -0xE0, sourceIsIndirect: true);
                        XS.Set(RCX, RBP, sourceDisplacement: -0xE0, sourceIsIndirect: true);
                        // OK now we put in ECX the last bit of our unsigned value,  we call it "SIGN_BIT" but is a little improper...
                        XS.ShiftRight(RCX, 31);
                        /*
